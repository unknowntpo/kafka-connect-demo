...
電商平台常用熱門商品帶動限量折價券活動。當商品突然爆紅，折價券可能在短時間內被大量搶領，營運與工程團隊需要近即時觀察流量壓力、領券成功與失敗、售罄原因與地區分布。這類需求看起來像 dashboard 問題，實際上會牽涉事件設計、資料管線、Kafka、Kafka Connect、Elasticsearch 與 Kibana 的分工。
...
假設今晚 8 點有一個商品突然爆紅，平台同步推出限量折價券。營運與工程團隊需要快速判斷：
